...
void hiho::ad00_primitive_double(double s, double sigma, double k, double r, double t, int simulation)
{
	...
	std::cout << __func__ << " : " << timer.value << ", time : " << timer.duration() << " msec" << ", delta : " << (hiho::american(s + 0.0001, sigma, k, r, t, simulation) - hiho::american(s - 0.0001, sigma, k, r, t, simulation)) / 0.0001 / 2
