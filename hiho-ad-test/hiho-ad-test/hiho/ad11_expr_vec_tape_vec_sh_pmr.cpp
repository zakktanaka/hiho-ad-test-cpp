...
void hiho::ad11_expr_vec_tape_vec_sh_pmr(double s, double sigma, double k, double r, double t, int simulation)
{
	auto mr = pmr::unsynchronized_pool_resource();
	auto df = pmr::get_default_resource();
